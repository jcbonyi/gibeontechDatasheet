...
import { authCookieOptions, createToken, hashPassword } from '@/lib/auth';
...
export async function POST(req: NextRequest) {
  try {
    ...
    return handleRouteError(err, 'POST /api/auth/bootstrap');
  }
}
...
export async function GET() {
  try {
    ...
    return handleRouteError(err, 'GET /api/auth/bootstrap');
  }
}
